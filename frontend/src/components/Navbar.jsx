    ...
    <header className="sticky top-0 z-40 border-b border-navy-800/10 bg-paper-50/85 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <div className="flex items-center gap-3">
          <button
            type="button"
            className="press rounded-full border border-navy-800/15 px-3 py-1.5 text-sm font-semibold text-navy-800 hover:bg-navy-900/5"
          ...
          <NavLink
            to="/chat"
            className="press shine hidden rounded-full bg-saffron-500 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-saffron-600 sm:block"
          >
            Ask Sarthi
          </NavLink>
        </div>
