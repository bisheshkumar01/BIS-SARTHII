      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-display text-sm font-bold text-navy-900">BIS SĀRTHI</span>
          </div>
          <p className="max-w-xl text-sm leading-relaxed text-navy-700/70">
            ...
            BIS SĀRTHI does not replace the Bureau of Indian Standards — it helps you navigate it.
          </p>
        </div>
